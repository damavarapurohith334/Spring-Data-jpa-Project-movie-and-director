...
//
//import com.rohi.constants.ValidationConstants;
//
...
//	     error.setMessage(environment.getProperty(ValidationConstants.SOMETHING_WENT_WRONG.toString()));
//	     return new ResponseEntity<>(error, HttpStatus.INTERNAL_SERVER_ERROR);
//	}
//    @ExceptionHandler(RecordNotFoundException.class)
//    public ResponseEntity<String> handleRecordNotFoundException(RecordNotFoundException ex) {
//        String errorMessage = messageSource.getMessage("notFound", null, LocaleContextHolder.getLocale());
//        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorMessage);
//    }
//
//    @ExceptionHandler(DirectorDetailsNotFoundException.class)
//    public ResponseEntity<String> handleDirectorDetailsNotFoundException(DirectorDetailsNotFoundException ex) {
//        String errorMessage = messageSource.getMessage("directorDetailsNotFound", null, LocaleContextHolder.getLocale());
//        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorMessage);
//    }
//
